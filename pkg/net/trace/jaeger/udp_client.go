...
import (
	...
	"github.com/bilibili/kratos/pkg/net/trace/jaeger/thrift-gen/jaeger"
)
...
func NewAgentClientUDP(hostPort string, maxPacketSize int) (*AgentClientUDP, error) {
	...
	client := jaeger.NewAgentClientFactory(thriftBuffer, protocolFactory)
